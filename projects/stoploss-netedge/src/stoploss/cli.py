...
app = typer.Typer(
    help="Stop Loss Net Edge: Precision futures calculator with full cost accounting"
)
...
def pnl(
    ...
    from stoploss.rates import calculate_total_margin_interest, MarginLoan
    ...
    try:
        ...
        margin_int = (
            calculate_total_margin_interest(loans_list) if loans_list else Decimal("0")
        )
